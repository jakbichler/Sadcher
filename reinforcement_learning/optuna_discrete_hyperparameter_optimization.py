...
from models.policy_value_discrete import SchedulerPolicy, SchedulerValue, ZeroCritic

SAFE_BATCH_SAMPLES_FROZEN = 2048
SAFE_BATCH_SAMPLES_UNFROZEN = 1024
MAX_EPISODES = 500_000  # hard cap per trial
REPORT_EVERY = 1_000
PLATEAU_DELTA = 0.002  # min absolute improvement considered “progress”
...
def get_study(storage_url: str, study_name: str, resume: bool) -> optuna.Study:
    return optuna.create_study(
        ...
        pruner=optuna.pruners.MedianPruner(n_startup_trials=10, n_warmup_steps=100_000),
    )
...
def suggest_params(trial: optuna.Trial) -> Dict:
    cfg: Dict = {}
    cfg["n_envs"] = trial.suggest_categorical("n_envs", [32, 48, 64, 128, 256])
    cfg["n_rollouts"] = trial.suggest_categorical("n_rollouts", [32, 64, 96, 128])
    # cfg["policy_type"] = trial.suggest_categorical("policy_type", ["simple", "IL_pretrained"])
    cfg["learning_epochs"] = trial.suggest_categorical("learning_epochs", [4, 8, 12, 16])
    cfg["learning_rate"] = trial.suggest_categorical("learning_rate", [1e-5, 3e-5, 5e-5])
    ...
    print(batch_size, "/", batch_divider, "  ", batch_size / batch_divider)
...
########################################################## 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096#####################
#  Training                                                                   #
##################################################### 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096 2304 4096##########################
...
def objective(trial: optuna.Trial):
    ...
    RL_pretrained_path = "/home/jakob/thesis/reinforcement_learning/archived_runs/revisit_discrete/25-05-15_all_instances_frozen_encoders/checkpoints/best_agent.pt"
    agent.load(path=RL_pretrained_path)
